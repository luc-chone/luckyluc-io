...
// From https://github.com/ssatguru/BabylonJS-CharacterController/
export class CharacterController {
	...
	constructor(avatar: Mesh | { mainMesh: Mesh }, camera: ArcRotateCamera, scene: Scene) {

		this.avatar = (avatar instanceof Mesh) ? avatar : avatar.mainMesh;
		this.scene = scene;
	...
	private prevAnim: AnimData | null = null;
	...
	private snapCamera() {
		...
		let pi: PickingInfo | null = this.scene.pickWithRay(this.ray, (mesh) => {
...
export class Key {
	...
	public stepRight = false;
	public stepLeft = false;
	public jump = false;
	public shift = false;
